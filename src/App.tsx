    ...
    <div className="relative min-h-screen bg-white font-inter" style={{
      ...
      <section id="home" className="relative h-screen overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 md:px-6">
          ...
          <div className="mb-4 sm:mb-5 md:mb-6 lg:mb-8 animate-fade-in-down">
            <div className="inline-flex items-center space-x-1.5 sm:space-x-2 bg-transparent backdrop-blur-sm px-4 sm:px-5 md:px-6 lg:px-8 py-1.5 sm:py-2 md:py-2.5 lg:py-3 rounded-full">
      ...
      <section id="reservation" className="py-10 sm:py-12 md:py-16 lg:py-20 bg-gray-900">
        <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          ...
          <div className="bg-gray-800 rounded-xl sm:rounded-2xl shadow-2xl p-8 sm:p-10 md:p-12 lg:p-16 text-center">
            <div className="space-y-6 sm:space-y-8">
              <div className="max-w-2xl mx-auto">
                <div className="mb-8">
                  <svg className="w-20 h-20 sm:w-24 sm:h-24 mx-auto mb-6 text-green-500" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">Book via WhatsApp</h3>
                  <p className="text-gray-300 text-base sm:text-lg mb-6">Click the button below to reserve your table instantly through WhatsApp</p>
                </div>
                
                <a
                  href="https://wa.me/917029252941?text=Hi%20Velvet%20%26%20Vine%2C%20I%27d%20like%20to%20book%20a%20table.%20Please%20help%20me%20with%20the%20reservation."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center space-x-3 bg-green-500 hover:bg-green-600 active:bg-green-700 text-white px-8 sm:px-10 md:px-12 py-4 sm:py-5 md:py-6 rounded-xl font-bold text-lg sm:text-xl md:text-2xl transition-all duration-300 shadow-2xl hover:shadow-green-500/50 transform hover:scale-105 active:scale-100"
                >
                ...
                <div className="mt-8 pt-8 border-t border-gray-700">
                  <p className="text-gray-400 text-sm sm:text-base">Or call us directly:</p>
                  <div className="mt-3 space-y-2">
                    <a href="tel:+918260506650" className="block text-white hover:text-red-500 font-semibold text-lg transition-colors">
                      +91-8260506650
                    </a>
                    <a href="tel:+917029252941" className="block text-white hover:text-red-500 font-semibold text-lg transition-colors">
                      +91-7029252941
                    </a>
                  </div>
                </div>
